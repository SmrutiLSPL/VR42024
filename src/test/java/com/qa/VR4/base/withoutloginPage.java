...
import com.qa.VR4.factory.OptionsManager;
import com.qa.VR4.pages.LoginPage;
import com.qa.VR4.utils.ElementUtil;
import com.qa.VR4.utils.JSONUtils;
...
public class withoutloginPage {
    ...
    By emailAddress=By.xpath("//input[@name='Users[email]']");
...
//
    ...
    public boolean loginUser(String username,String pwd,String visibleText) throws InterruptedException{
        ...
        driver.manage().deleteCookie(driver.manage().getCookieNamed("PHPSESSID"));
//        Cookie cookie = driver.manage().getCookieNamed("CAKEPHP");
//        if (cookie != null) {
...
//        }
        ...
        System.out.println("user login called123");
