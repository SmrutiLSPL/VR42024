...
public class VRUtils {
    ...
    public void doClickanyMenu(String menuName, int timeOut) {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut));
        wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//span[text()='" + menuName + "']")))).click();
    }
